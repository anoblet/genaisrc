...
const parameters = {
  ...
  auto: {
    ...
    default: false,
    description:
      "Automatically stage all files, commit with generated message, and push changes",
  },
  excludeFromAnalysis: {
    type: "array",
    default: ["package-lock.json", "**/package-lock.json"],
    description:
      "Files to exclude from analysis when generating commit message but still include in the commit",
  },
};
...
export const message = async () => {
  ...
  if (auto && !hasStaged) {
    ...
    console.log(
      "Auto mode: Files already staged, proceeding with existing staged files"
    );
  }
